...
## Design system
- Pakistan Green `#01411C` (primary accent — header/footer/links/small accents, not a wash), Green Light `#0A5C2E` (hover), Ink `#121212`, Off-White paper `#FFFEFA`, Warm Clay `#E8DDD0`, Stone `#D8D0C5`, Error `#8B1E1E`
- Logo: word logo, three lines — `FREEDOM GENERATION` (serif bold) / `SCHOOL` (sans light) / `"teach your children well"` (serif italic). No emblem or icon.
