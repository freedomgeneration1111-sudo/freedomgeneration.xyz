// src/content/journal.ts — 3 Seed Entries for Launch — Bilingual EN/UR
...
export const journal: JournalEntry[] = [
  {
    ...
    coverId: "TODAY-01",
    galleryIds: ["TODAY-02", "TODAY-03", "LEARNING-01", "FAITH-01", "TEACHING-02"],
...
اسی لیے ہم اسے فریڈم جنریشن کہتے ہیں۔ "اگر تم میرے کلام میں قائم رہو گے... تو حق کو جانو گے اور حق تمہیں آزاد کرے گا۔" یوحنا 8:31-32۔`
  ...
  },
  {
    ...
    coverId: "PROJECT-01",
    galleryIds: ["PROJECT-02", "PROJECT-03", "PROJECT-04", "TRANSPARENCY-01", "FOOTER-TRUST"],
    author: "Komal Shahzadi",
    body: {
